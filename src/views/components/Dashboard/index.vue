			...
			<v-row dense>
				<v-col cols="12">
					<app-widget title="Line Chart">
						...
						<option-chart slot="widget-content" height="350px" width="100%" :chart-data="getChartOption('line')" />
					</app-widget>
				</v-col>
			</v-row>
			<v-row dense>
				<v-col cols="12" sm="6" md="4">
					<app-widget title="Raddar Chart">
						<option-chart slot="widget-content" height="300px" width="100%" :chart-data="getChartOption('raddar')" />
					</app-widget>
				</v-col>
				<v-col cols="12" sm="6" md="4">
					<app-widget title="Pie Chart">
						<option-chart slot="widget-content" height="300px" width="100%" :chart-data="getChartOption('pie')" />
					</app-widget>
				</v-col>
				<v-col cols="12" sm="6" md="4">
					<app-widget title="Bar Chart">
						<option-chart slot="widget-content" height="300px" width="100%" :chart-data="getChartOption('bar')" />
					</app-widget>
				</v-col>
			</v-row>
			<v-row dense>
				<v-col lg="7" sm="12" cols="12">
					<app-widget title="Projects" padding-hide>
						<plain-table slot="widget-content" />
					</app-widget>
				</v-col>
				<v-col lg="5" sm="12" cols="12">
					<app-widget title="Orders" padding-hide>
...
<script>
import { lineChartData, getLineChartOption, getRaddarChartOption, getPieChartOption, getBarChartOption } from '@/api/mock';
